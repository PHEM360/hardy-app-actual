...
import { Wallet, Plus, Eye, EyeOff, Edit2, Archive, RotateCcw, Table2, LineChart as LineChartIcon, Settings2, X, CalendarRange } from "lucide-react";
      ...
      <div className="flex items-center gap-2 mb-4 flex-wrap">
        ...
        {viewMode === "chart" && (
          <button
            ...
            className={`h-8 px-3 rounded-lg text-xs font-medium flex items-center gap-1.5 transition-colors ${showTaxYears ? "bg-primary/10 text-primary" : "bg-muted text-muted-foreground hover:text-foreground"}`}
          >
